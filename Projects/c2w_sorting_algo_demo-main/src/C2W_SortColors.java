...
public class C2W_SortColors extends Application {
    ...
    public void start(Stage stage) {
        ...
        canvas = new Canvas(12+12*Array_Size, 206);
        ...
        stage.setTitle("Quicksort Algorith Animation");
